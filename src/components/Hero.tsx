        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-7 animate-fade-up">
            ...
            <p className="text-gray-600 text-lg mb-8 max-w-2xl">
              I design efficient server-side architectures and APIs that provide dependable user experiences. With experience in modern backend technologies, I translate complex business requirements into maintainable, production-ready systems.
            </p>
